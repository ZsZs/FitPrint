...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" url="..\..\test\resources\Corrected.html" htmlbaseurl="" outputurl="..\..\test\resources\ExtraxtedHtml.xml" processortype="saxon8" useresolver="yes"
